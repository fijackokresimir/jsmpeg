...
var Player = function(url, options) {
	...
	// Parameters (url, options) are not changed so that we don't break other sources
	// For webrtc, set url to '', and pass options only (inside options put rtcPeerConnection
	// and rtcDataChannel
	if (options.source === JSMpeg.Source.WebRTC) {
		this.source = new JSMpeg.Source.WebRTC(options);
...
Player.prototype.switchToRTC = function(options) {
	this.options = options || {};
